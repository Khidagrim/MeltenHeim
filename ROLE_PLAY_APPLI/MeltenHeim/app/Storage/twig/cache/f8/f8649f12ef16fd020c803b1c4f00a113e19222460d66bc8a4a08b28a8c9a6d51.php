...
class __TwigTemplate_72d9f34d91943fc15b196fd729daf4c469ead13e724bbf49dd6bf8934738f0e8 extends Twig_Template
{
    private $source;
...
<form action=\"";
        // line 7
        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('url')->getCallable(), array(("/backoffice/classrooms/edit/" . twig_get_attribute($this->env, $this->source, ($context["classroom"] ?? null), "id", array())))), "html", null, true);
        echo "\" method=\"post\">
